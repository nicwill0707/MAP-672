...
Note: there are many ways to build a web page or website, and there are many resources out there providing pre-built templates, frameworks, boilerplates, and skeletons. Feel free to follow along with the basic web portfolio this lesson guides you through. However, you may wish to experiment with another resource. Checkout:

* [Bootstrap](http://getbootstrap.com/)
* [HTML5 Boilerplate](https://html5boilerplate.com/)
* [18 Best HTML5/CSS3 Portfolio Website Templates](https://colorlib.com/wp/html5-portfolio-website-templates/)
...
## 2. Using GitHub Pages to serve maps from specific GitHub repositories
...
**NOTE:** What follows demonstrates two options for publishing web pages and applications. Option #2 is more simple and easier than option #1.

### Option #1: Using a gh-pages branch
...
### Option #2: Simpler GitHub Pages publishing

Rather than creating (and updating) a gh-pages branch from your master branch, GitHub recently introduced a simpler way. Within the Settings of any GitHub repository, you can simply enable the master branch as the source for building GitHub Pages from that repository.

See [Simpler GitHub Pages publishing](https://github.com/blog/2228-simpler-github-pages-publishing).
